...
**The lesson is about how the gaps were found, not about the gaps.** Three of the four closed ones were discovered by a person trying to use the feature, months apart. The fourth was found in ten minutes by grepping this document for rows claiming a portable format and checking each against the code — which is what produced the "still open" list above as well.
