...
- **Coverage is stated, and so are the gaps.** Ford trucks, Bronco and vans 1948–80; Chevrolet and GMC trucks and vans 1947–80; Dodge trucks and vans 1971–80 — 27 schemes across four makes. Deliberately absent, each for a reason recorded beside it: Chevrolet 1953–55 1st series, whose one-letter series codes leave too little to identify a vehicle by; GMC 1951–55 1st series and GMC 1960–66, whose sheets say outright that the codes alone do not give the year; the production-number charts several sheets offer, which would narrow years the codes leave open and are not transcribed yet; and everything from 1981, which is vPIC's job and which it does with more detail than these sheets carry.
...
- **Read-only.** This interprets a number and shows what it says. It does not write to the vehicle.
