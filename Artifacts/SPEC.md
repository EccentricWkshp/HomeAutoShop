...
| FR-VEH-10 | Show a single vehicle timeline merging work orders, purchases, odometer readings, documents, diagnostics, and recalls in date order. |
...
| FR-TIME-1 | Log time against a work order or job item, by timer or manual entry, attributed to a user. |
