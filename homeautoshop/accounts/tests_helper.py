...
CLOSED_TO_HELPERS = frozenset({
    ...
    "backup_download", "backup_now", "backup_stop", "backup_upload",
    ...
    "manual_libraries", "manual_library_action", "ocr_retry", "order_import", "ownership_add", "ownership_end", "part_create",
    ...
    "service_info_visibility", "settings", "settings_email_test",
    "settings_restart", "setup",
    "code_define",
    ...
    "part_photo_upload", "part_usage_edit",
