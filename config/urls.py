...
urlpatterns = [
    ...
    path("templates/<uuid:pk>/remove/", catalog.template_delete, name="template_delete"),
    path("checklists/<uuid:pk>/remove/", catalog.checklist_delete, name="checklist_delete"),
